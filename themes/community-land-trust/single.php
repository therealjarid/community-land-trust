...
<div id="primary" class="content-area">
    ...
    <div class="media-container">
            ...
            <div class='social-container'>
                <div class="social-links">
                    ...
                    <ul class="media-share">
                        ...
                        <!-- twitter share -->
                        <li class="twitter">
                            <a href="http://twitter.com/intent/tweet?text=Currently reading from @<?php echo esc_html( CFS()->get( 'twitter_user' ) ); ?>: '<?php the_title(); ?>'&amp;url=<?php the_permalink(); ?>&amp;hashtags=<?php echo esc_html( CFS()->get( 'twitter_hashtag' ) ); ?>"
        ...
        <div class="navigation-links">
            ...
            <div class="middle"><a href="<?php echo get_permalink( get_page_by_title( 'Media' ) ) ?>"><span
                            class="break">Back to </span>Media</a></div>
